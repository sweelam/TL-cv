...
\resumeSubHeadingListStart
		  ...
		  \resumeProjectHeading
			...
			\resumeItemListStart		  
          			...
          			\resumeItem {Handled the complete Software Development Life Cycle (SDLC), from requirements gathering to product go-live.}
          			\resumeItem {Designed solutions, and ensured adherence to best practices and the latest technology stack.}
          			\resumeItem {Consistently ensured that objectives were met across the business vertical, in line with company-wide goals.}
          \resumeItemListEnd 
...
\section{Skills}
	...
	\resumeProjectHeading
	  ...
	  \resumeItemListStart
    	\resumeItem {Languages 					\hfill Java, Kotlin, Go, Javascript, Python, \LaTeX }
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
    	...
    	\resumeProjectHeading
        {\textbf{Murabaha (Tawarroq)} $|$ \footnotesize\emph{Java (Spring Boot), RabbitMQ, MySQL , Redis, and GCP}}{10.20204 --  Present}
        \resumeItemListStart
            \resumeItem{Islamic term that helps companies to provide Islamic loan through a well-defined work flow. Murabaha is new product in the company which increases the overall revenue. } 
            \resumeItem{Project lead who designed the solution, and delivered it.}
            \resumeItem{Requirements analysis, RFC maker}
            \resumeItem{Designed the solution and decided the tech-stack for the system}
            \resumeItem{Developed, tested, delivered the system, and ensured the system is highly scalable}
            \resumeItem{Defined NewRelic required dashboard, and alerts} 
          \resumeItemListEnd
