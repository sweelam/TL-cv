...
\resumeSubHeadingListStart
		  ...
		  \resumeProjectHeading
	          {\textbf{Staff Software Engineer} $|$ \footnotesize\emph{Tamara - UAE}\vspace{4pt}}{04/2023 -- Present}
			\resumeItemListStart		  
          			\resumeItem {Tamara is the leading fintech platform to shop, pay and bank in Saudi Arabia and the wider GCC region} 
          			\resumeItem {Core member in Compliance vertical who consistently ensured that objectives were met across the business vertical, in line with company-wide goals.}
          			\resumeItem {Led engineering improvements and ensured adherence to industry best practices and modern technologies.}
          			\resumeItem {Initiated and led the adoption of AI within the engineering organization by designing, developing, and deploying an LLM-based automation tool.}
          			\resumeItem {Coach and Mentor for Junior and Senior Engineers, who helped them to move forward in career progression}
          \resumeItemListEnd 
...
\section{Skills}
	...
	\resumeProjectHeading
	  ...
	  \resumeItemListStart
    	\resumeItem {Languages 					\hfill Java, Kotlin, Go, and \LaTeX }
    	\resumeItem {Frameworks					\hfill Spring Boot, Spring Cloud, Gin, and Echo}
...
% -------------------- PROJECTS --------------------
\section{Projects}
    \textit{\textbf {The following projects are some of the core projects I had worked with, not all!}}
    \resumeSubHeadingListStart
    
    	\resumeProjectHeading
        {\textbf{Murabaha (Tawarroq)} $|$ \footnotesize\emph{Java (Spring Boot), RabbitMQ, MySQL, Redis, and GCP}}{10/2020 -- Present}
        \resumeItemListStart
            \resumeItem{An Islamic financing product that enables companies to offer Sharia-compliant loans through a structured workflow. As a newly launched product, Murabaha contributed to increasing overall company revenue.}
            \resumeItem{Led the entire project lifecycle — from requirements gathering and RFC documentation to solution architecture and successful delivery.}
            \resumeItem{Designed the system architecture and selected the technology stack to meet scalability and reliability goals.}
            \resumeItem{Implemented, tested, and deployed the system, ensuring high performance, fault tolerance, and scalability.}
            \resumeItem{Defined New Relic dashboards and alerting mechanisms to monitor system health and performance effectively.}
        \resumeItemListEnd
