...
<<<<<<< HEAD
          			\resumeItem {Core member in Compliance department}
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
    	...
    	\resumeProjectHeading
        {\textbf{Murabaha (Tawarroq)} $|$ \footnotesize\emph{Java (Spring Boot), RabbitMQ, MySQL , Redis, and GCP}}{Present}
        \resumeItemListStart
            \resumeItem{Islamic term that helps companies to provide Islamic loan through a well-defined work flow}
            ...
            \resumeItem{Coder, Reviewer and Mentor}
             \resumeItem{ A new product in the company which increases the overall revenue. } 
          \resumeItemListEnd
