...
\resumeSubHeadingListStart
          ...
          \resumeProjectHeading
	          {\textbf{Technical Lead} $|$ \footnotesize\emph{Almosafer - UAE}\vspace{4pt}}{03/2023 -- Present}
			\resumeItemListStart		  
          			...
          			\resumeItem {Analysed existing systems, identified and resolved bottlenecks.}
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
        {\textbf{ID Verification (IDV)} $|$ \footnotesize\emph{Java, RabbitMQ, MySQL , Redis}}{Present}
        \resumeItemListStart
            ...
            \resumeItem{Lead the project, and managed the team}
